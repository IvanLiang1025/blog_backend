package com.ivan.sunnyblog.web.cache.iservice;
...
// ============================String=============================
     ...
     * @param key   键
     * @param value 值
     * @param time  时间(秒) if time<=0, never expire
     */
     ...
     * @param map
     */
    void hset(String hash, Map<String, Object> map);
     ...
     * @param hashValue
     */
    void hset(String hash, Object hashKey, Object hashValue);


    void hsetWithExpire(String hash, Object hashKey, Object hashValue, Long seconds);
     ...
     * @return
     */
    Object hget(String hash, Object hashKey);

    Map<Object, Object> hgetAll(String hash);

    void hIncr(String hash, Object hashKey, int increment);
     ...
     * @param hashKeys
     */
    void hDelete(String hash, Object... hashKeys);
