...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = -1197921367;
     ...
     */
    public final TableField<CategoryRecord, Long> CATEGORY_ID = createField("category_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('category_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
